...
teaser: Write the typed Python contract that the Payments and Compliance teams will share, then register a Nexus Endpoint that routes calls to the Compliance team.
notes:
- type: text
  contents: |-
